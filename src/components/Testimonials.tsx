      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <button
            ...
            className="absolute top-1/2 -left-6 md:-left-12 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-md hover:shadow-lg transition-shadow"
          ...
          <button
            ...
            className="absolute top-1/2 -right-6 md:-right-12 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-md hover:shadow-lg transition-shadow"
